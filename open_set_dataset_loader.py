'''
This is the dataset loader specially for open set evaluation where you put an attack type as
argument and dataloader returns examples from all attacks except that during training
and only that attack during tetsing.
'''
